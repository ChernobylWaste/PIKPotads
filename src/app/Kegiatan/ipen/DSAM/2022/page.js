...
export default function DSAM22() {
  return (
    <>
      {/* Banner */}
      ...
      <div class={`container py-5 ${style.font}`}>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4 py-5">
          ...
          <div class="col">
            <div class="card">
              <img
                src="/Kegiatan/Ipen/DSAM2022/1 (9).jpg"
                class="card-img-top"
                style={{ padding: "20px", "border-radius": "20" }}
                alt="..."
              />
          ...
          <div class="col">
            <div class="card">
              <img
                src="/Kegiatan/Ipen/DSAM2022/1 (11).jpg"
                class="card-img-top"
                style={{ padding: "20px", "border-radius": "20" }}
                alt="..."
              />
          ...
          <div class="col">
            <div class="card">
              <img
                src="/Kegiatan/Ipen/DSAM2022/1 (14).jpg"
                class="card-img-top"
                style={{ padding: "20px", "border-radius": "20" }}
                alt="..."
              />
          ...
          <div class="col">
            <div class="card">
              <img
                src="/Kegiatan/Ipen/DSAM2022/1 (15).jpg"
                class="card-img-top"
                style={{ padding: "20px", "border-radius": "20" }}
                alt="..."
              />
          ...
          <div class="col">
            <div class="card">
              <img
                src="/Kegiatan/Ipen/DSAM2022/1 (16).jpg"
                class="card-img-top"
                style={{ padding: "20px", "border-radius": "20" }}
                alt="..."
              />
          ...
          <div class="col">
            <div class="card">
              <img
                src="/Kegiatan/Ipen/DSAM2022/1 (17).jpg"
                class="card-img-top"
                style={{ padding: "20px", "border-radius": "20" }}
                alt="..."
              />
          ...
          <div class="col">
            <div class="card">
              <img
                src="/Kegiatan/Ipen/DSAM2022/1 (18).jpg"
                class="card-img-top"
                style={{ padding: "20px", "border-radius": "20" }}
                alt="..."
              />
          ...
          <div class="col">
            <div class="card">
              <img
                src="/Kegiatan/Ipen/DSAM2022/1 (19).jpg"
                class="card-img-top"
                style={{ padding: "20px", "border-radius": "20" }}
                alt="..."
              />
          ...
          <div class="col">
            <div class="card">
              <img
                src="/Kegiatan/Ipen/DSAM2022/1 (13).jpg"
                class="card-img-top"
                style={{ padding: "20px", "border-radius": "20" }}
                alt="..."
              />
